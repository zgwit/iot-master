...
const docTemplatemaster = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/curd.ReplyData-types_Space"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/curd.ReplyList-types_Space"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/curd.ReplyData-array_types_SpaceDevice"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.SpaceDevice"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "curd.ReplyData-array_types_SpaceDevice": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
