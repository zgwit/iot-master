...
@Component({
  selector: 'app-edit-commands',
  templateUrl: './edit-commands.component.html',
  styleUrls: ['./edit-commands.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => EditCommandsComponent),
      multi: true
    }
  ]
})
export class EditCommandsComponent implements OnInit, ControlValueAccessor {
  onChanged: any = () => {
  }
  onTouched: any = () => {
  }
