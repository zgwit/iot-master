...
const routes: Routes = [
  {
    ...
    children: [
      {path: '', component: WelcomeComponent, data:{breadcrumb:"首页"}},
      {path: 'dash', component: DashComponent},
      {path: 'home', component: HomeComponent, data:{breadcrumb:"首页"}},
      {path: 'tunnel', component: TunnelComponent, data:{breadcrumb:"通道"}},
      {path: 'tunnel/:id', component: TunnelDetailComponent, data:{breadcrumb:"详情"}},
