...
@Component({
  selector: 'app-edit-aggregators',
  templateUrl: './edit-aggregators.component.html',
  styleUrls: ['./edit-aggregators.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => EditAggregatorsComponent),
      multi: true
    }
  ]
})
export class EditAggregatorsComponent implements OnInit, ControlValueAccessor {
  onChanged: any = () => {
  }
  onTouched: any = () => {
  }
